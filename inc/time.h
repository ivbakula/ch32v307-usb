...
extern uint32_t sysclock_frequency; /*!< This is global variable. Read this variable to check what
                                     ...
                                     * sysclock frequency, you shoudl change this variable to appropriate
                                     * value */
/**
 *
 */ 
 ...
 *        refclock frequency and multiplication factor. For list of available multiplication factors
 *        consult with PllMul enum. 
 *        
